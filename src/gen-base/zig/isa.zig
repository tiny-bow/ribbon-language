...
pub const Operand = enum {
    ...
    pub fn writeShorthandType(self: Operand, writer: anytype) !void {
        switch (self) {
            ...
            .builtin => try writer.writeAll("BuiltinId"),
        ...
        &.{
            ...
            .mnemonic(
                ...
                &.{
                    ...
                    .basic(.suffix("x"), "Get the address of {1}, placing it in {0}; {0} = &{1}", &.{ .register, .foreign }),
                    .basic(.suffix("c"), "Get the address of {1}, placing it in {0}; {0} = &{1}", &.{ .register, .constant }),
                },
            ),
            .mnemonic(
                "load",
                ...
                &.{
                    .basic(.suffix("8"), "Loads an 8-bit value from memory at the address in {1} offset by {2}, placing the result in {0}; {0} = *({1} + {2})", &.{ .register, .register, .int }),
                    .basic(.suffix("16"), "Loads a 16-bit value from memory at the address in {1} offset by {2}, placing the result in {0}; {0} = *({1} + {2})", &.{ .register, .register, .int }),
                    .basic(.suffix("32"), "Loads a 32-bit value from memory at the address in {1} offset by {2}, placing the result in {0}; {0} = *({1} + {2})", &.{ .register, .register, .int }),
                    .basic(.suffix("64"), "Loads a 64-bit value from memory at the address in {1} offset by {2}, placing the result in {0}; {0} = *({1} + {2})", &.{ .register, .register, .int }),
                },
            ),
            .mnemonic(
                "store",
                ...
                &.{
                    .basic(.suffix("8"), "Stores an 8-bit value from {1} to memory at the address in {0} offset by {2}; *({0} + {2}) = {1}", &.{ .register, .register, .int }),
                    .basic(.suffix("16"), "Stores a 16-bit value from {1} to memory at the address in {0} offset by {2}; *({0} + {2}) = {1}", &.{ .register, .register, .int }),
                    .basic(.suffix("32"), "Stores a 32-bit value from {1} to memory at the address in {0} offset by {2}; *({0} + {2}) = {1}", &.{ .register, .register, .int }),
                    .basic(.suffix("64"), "Stores a 64-bit value from {1} to memory at the address in {0} offset by {2}; *({0} + {2}) = {1}", &.{ .register, .register, .int }),
                    .basic(.suffix("8c"), "Stores an 8-bit value ({1}) to memory at the address in {0} offset by {2}; *({0} + {2}) = {1}", &.{ .register, .byte, .int }),
                    .basic(.suffix("16c"), "Stores a 16-bit value ({1}) to memory at the address in {0} offset by {2}; *({0} + {2}) = {1}", &.{ .register, .short, .int }),
                    .basic(.suffix("32c"), "Stores a 32-bit value ({1}) to memory at the address in {0} offset by {2}; *({0} + {2}) = {1}", &.{ .register, .int, .int }),
                    .basic(.suffix("64c"), "Stores a 64-bit value (encoded as {2}) to memory at the address in {0} offset by {1}; *({0} + {1}) = {2}", &.{ .register, .int, .word }),
                },
            ),
        },
    ),
