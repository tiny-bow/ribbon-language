    ...
    .category("Integer arithmetic",
        ...
        , &.{
            ...
            .mnemonic("i_div",
                ...
                &.{
                    .basic(.override("u_add8"), "8-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .register }),
                    .basic(.override("u_add16"), "16-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .register }),
                    .basic(.override("u_add32"), "32-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .register }),
                    .basic(.override("u_add64"), "64-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .register }),

                    .basic(.override("u_add8a"), "8-bit unsigned {0} = {2} / {1}", &.{ .register, .register, .byte }),
                    .basic(.override("u_add16a"), "16-bit unsigned {0} = {2} / {1}", &.{ .register, .register, .short }),
                    .basic(.override("u_add32a"), "32-bit unsigned {0} = {2} / {1}", &.{ .register, .register, .int }),
                    .basic(.override("u_add64a"), "64-bit unsigned {0} = {2} / {1}", &.{ .register, .register, .word }),

                    .basic(.override("u_add8b"), "8-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .byte }),
                    .basic(.override("u_add16b"), "16-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .short }),
                    .basic(.override("u_add32b"), "32-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .int }),
                    .basic(.override("u_add64b"), "64-bit unsigned {0} = {1} / {2}", &.{ .register, .register, .word }),

                    .basic(.override("s_add8"), "8-bit signed {0} = {1} / {2}", &.{ .register, .register, .register }),
                    .basic(.override("s_add16"), "16-bit signed {0} = {1} / {2}", &.{ .register, .register, .register }),
                    .basic(.override("s_add32"), "32-bit signed {0} = {1} / {2}", &.{ .register, .register, .register }),
                    .basic(.override("s_add64"), "64-bit signed {0} = {1} / {2}", &.{ .register, .register, .register }),

                    .basic(.override("s_add8a"), "8-bit signed {0} = {2} / {1}", &.{ .register, .register, .byte }),
                    .basic(.override("s_add16a"), "16-bit signed {0} = {2} / {1}", &.{ .register, .register, .short }),
                    .basic(.override("s_add32a"), "32-bit signed {0} = {2} / {1}", &.{ .register, .register, .int }),
                    .basic(.override("s_add64a"), "64-bit signed {0} = {2} / {1}", &.{ .register, .register, .word }),

                    .basic(.override("s_add8b"), "8-bit signed {0} = {1} / {2}", &.{ .register, .register, .byte }),
                    .basic(.override("s_add16b"), "16-bit signed {0} = {1} / {2}", &.{ .register, .register, .short }),
                    .basic(.override("s_add32b"), "32-bit signed {0} = {1} / {2}", &.{ .register, .register, .int }),
                    .basic(.override("s_add64b"), "64-bit signed {0} = {1} / {2}", &.{ .register, .register, .word }),
                },
            ),
            ...
            .mnemonic("i_rem",
                ...
                &.{
                    ...
                    .basic(.override("u_rem6"), "16-bit unsigned {0} = {1} % {2}", &.{ .register, .register, .register }),
                    .basic(.override("u_rem2"), "32-bit unsigned {0} = {1} % {2}", &.{ .register, .register, .register }),
                    .basic(.override("u_rem4"), "64-bit unsigned {0} = {1} % {2}", &.{ .register, .register, .register }),

                    .basic(.override("u_rema"), "8-bit unsigned {0} = {2} % {1}", &.{ .register, .register, .byte }),
                    .basic(.override("u_rema"), "16-bit unsigned {0} = {2} % {1}", &.{ .register, .register, .short }),
                    .basic(.override("u_rema"), "32-bit unsigned {0} = {2} % {1}", &.{ .register, .register, .int }),
                    .basic(.override("u_rema"), "64-bit unsigned {0} = {2} % {1}", &.{ .register, .register, .word }),

                    .basic(.override("u_remb"), "8-bit unsigned {0} = {1} % {2}", &.{ .register, .register, .byte }),
                    .basic(.override("u_remb"), "16-bit unsigned {0} = {1} % {2}", &.{ .register, .register, .short }),
                    .basic(.override("u_remb"), "32-bit unsigned {0} = {1} % {2}", &.{ .register, .register, .int }),
                    .basic(.override("u_remb"), "64-bit unsigned {0} = {1} % {2}", &.{ .register, .register, .word }),

                    .basic(.override("s_rem8"), "8-bit signed {0} = {1} % {2}", &.{ .register, .register, .register }),
                    .basic(.override("s_rem6"), "16-bit signed {0} = {1} % {2}", &.{ .register, .register, .register }),
                    .basic(.override("s_rem2"), "32-bit signed {0} = {1} % {2}", &.{ .register, .register, .register }),
                    .basic(.override("s_rem4"), "64-bit signed {0} = {1} % {2}", &.{ .register, .register, .register }),

                    .basic(.override("s_rema"), "8-bit signed {0} = {2} % {1}", &.{ .register, .register, .byte }),
                    .basic(.override("s_rema"), "16-bit signed {0} = {2} % {1}", &.{ .register, .register, .short }),
                    .basic(.override("s_rema"), "32-bit signed {0} = {2} % {1}", &.{ .register, .register, .int }),
                    .basic(.override("s_rema"), "64-bit signed {0} = {2} % {1}", &.{ .register, .register, .word }),

                    .basic(.override("s_remb"), "8-bit signed {0} = {1} % {2}", &.{ .register, .register, .byte }),
                    .basic(.override("s_remb"), "16-bit signed {0} = {1} % {2}", &.{ .register, .register, .short }),
                    .basic(.override("s_remb"), "32-bit signed {0} = {1} % {2}", &.{ .register, .register, .int }),
                    .basic(.override("s_remb"), "64-bit signed {0} = {1} % {2}", &.{ .register, .register, .word }),
                },
            ),
