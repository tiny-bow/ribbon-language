...
pub const PropertySet = std.ArrayHashMapUnmanaged(Rml.Obj(Rml.Symbol), Rml.Obj(Rml.ObjData), utils.SimpleHashContext, true);
...
pub fn isType(comptime T: type, obj: Object) bool {
    return utils.equal(obj.getTypeId(), Rml.TypeId.of(T));
}
