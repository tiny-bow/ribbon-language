...
fn run(comptime isLoop: bool, self: *core.mem.FiberHeader) core.Error!RunSignal {
    ...
    dispatch: switch (decode(callFrame, &instruction)) {
        ...
        .@"load8c" => pl.todo(noreturn, "load8c"),
        .@"load16c" => pl.todo(noreturn, "load16c"),
        .@"load32c" => pl.todo(noreturn, "load32c"),
        .@"load64c" => pl.todo(noreturn, "load64c"),
