...
pub const OpImmediate = packed struct {
    ...
    pub fn getMemory(self: anytype) TypeUtils.CopyConst([]u8, @TypeOf(self)) {
        return @as(TypeUtils.CopyConst([*]align(@alignOf(OpImmediate)) u8, @TypeOf(self)), @ptrCast(&self.data))[0..@sizeOf(u32)];
    }
...
pub const OpData = packed union {
    nop: void,
    halt: void, trap: void,
    block: void, with: void, @"if": ZeroCheck, when: ZeroCheck,
    re: OptZeroCheck, br: OptZeroCheck,
    call: void, prompt: void,
    ret: void, term: void,
    alloca: void, addr: void, read: void, write: void,
    load: void, store: void,
...
pub const Immediate = struct {
    ...
    pub fn getMemory(self: anytype) TypeUtils.CopyConst([]u8, @TypeOf(self)) {
        return @as(TypeUtils.CopyConst([*]align(@alignOf(OpImmediate)) u8, @TypeOf(self)), @ptrCast(&self.data))[0..@sizeOf(u64)];
    }
...
pub const Meta = union(enum) {
    ...
    pub fn getMemory(self: anytype) TypeUtils.CopyConst([]u8, @TypeOf(self)) {
        return @as(TypeUtils.CopyConst([*]align(@alignOf(Meta)) u8, @TypeOf(self)), @ptrCast(&self))[0..@sizeOf(Meta)];
    }
